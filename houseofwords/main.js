...
let face = "What you look at when talking to someone"; /*Between the quotation marks, 
...
let red = "the color of blood when oxygen hits it"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "where your thoughts come from"; //repeat the instructions for the word "brain"

let masculine = "man strength"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "having in mind"; //define 'think' in VERB form,
